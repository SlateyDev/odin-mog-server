...
SendClientLoginChallenge :: proc(ctx: ^srp6_context) -> (err: big.Error) {
	ClientLoginChallenge(ctx)
...
ServerLoginChallenge :: proc(ctx: ^srp6_context, PublicA: ^big.Int, Verifier: ^big.Int) -> (err: big.Error) {
...
SendClientLoginProof :: proc(
	...
	ClientLoginProof(ctx, PublicB, Salt, Username, Password)
